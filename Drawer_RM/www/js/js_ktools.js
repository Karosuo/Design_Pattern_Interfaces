...
function myUtilities(newContainer,newImagePanel, newFolders){
    ...
    this.setupMenu = function(){
        ...
        {
            $("#"+this.container+" .floatDiv").append("<p class='selectableDiv'>"+this.folders[i]+"</p>");
        }
    };
    ...
    this.setupDrawer = function(){
        ...
        $("#"+this.container+" .floatDiv .selectableDiv").click({param1:this.imp},this.selectFolder);
    };
    ...
    this.selectFolder = function(event){
        ...
        $(".floatDiv .selectableDiv").css("font-weight", "normal");                
        $(".floatDiv #"+this.innerHTML).css("font-weight", "bold");
        myImageGP.page = 1;
        myImageGP.loadPics();
    };
}
