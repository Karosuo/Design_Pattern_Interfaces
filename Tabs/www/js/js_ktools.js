...
function myUtilities(newContainer,newImagePanel, newFolders){
    ...
    this.setupMenu = function(){
        ...
        for(i=0; i<this.folders.length; i++)
        {
            ...
            $("#"+this.container+" .MenuDiv #"+this.folders[i]).css("background-color","rgb("+bkColor+","+bkColor+","+bkColor+")");
            bkColor = bkColor - 16;
        }
        ...
        $("#"+this.container+" .MenuDiv  .selectableDiv").click({param1:this.container},this.TabAnimate);
    };
    
    this.TabAnimate = function(event){
        var container = event.data.param1;
        var currentColor = $("#"+container+" .MenuDiv #"+this.innerHTML).css("background-color");
        //$("#"+container+" .MenuDiv  .selectableDiv #"+this.innerHTML).css("background-color");
        $("#"+container+" #image_board").css("background-color",currentColor);        
    };
